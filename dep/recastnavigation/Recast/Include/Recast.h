...
void rcAddSpan(rcContext* ctx, rcHeightfield& solid, const int x, const int y,
			   ...
			   const unsigned short area, const int flagMergeThr, bool clearExistinggeometry);
...
void rcRasterizeTriangle(rcContext* ctx, const float* v0, const float* v1, const float* v2,
						 ...
						 const int flagMergeThr = 1, bool clearExistinggeometry = false);
...
void rcRasterizeTriangles(rcContext* ctx, const float* verts, const int nv,
						  ...
						  rcHeightfield& solid, const int flagMergeThr = 1, bool clearExistinggeometry = false);
