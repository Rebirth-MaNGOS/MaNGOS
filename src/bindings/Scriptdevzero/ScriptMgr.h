...
struct Script
{
    Script() :
        ...
        pGossipSelectWithCode(NULL), pGossipSelectGOWithCode(NULL), pVendorIdNPC(NULL),
        ...
        pGOUse(NULL), pGOMobUse(NULL), pItemUse(NULL), pAreaTrigger(NULL), pProcessEventId(NULL),
	...
	uint32 (*pVendorIdNPC			)(Player*, Creature*);
	...
	bool (*pGOMobUse				)(Creature*, GameObject*);
