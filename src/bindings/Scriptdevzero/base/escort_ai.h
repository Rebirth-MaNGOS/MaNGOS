...
public:
	...
	void overrideDistanceLimit(bool);
	...
	// Control wether the npc should ignore pathing.
	void SetIgnorePathing(bool ignore);
...
private:
	...
	bool m_bIgnorePathing;
	bool m_bNoPlayerRangeLimit;
};
#endif
