...
npc_escortAI::npc_escortAI(Creature* pCreature) : ScriptedAI(pCreature),
	...
	m_bNoPlayerRangeLimit(false)
{}

void npc_escortAI::SetIgnorePathing(bool ignore)
{
	m_bIgnorePathing = ignore;
}
...
void npc_escortAI::overrideDistanceLimit(bool overrideLimit)
{
	m_bNoPlayerRangeLimit = overrideLimit;
}

bool npc_escortAI::IsPlayerOrGroupInRange()
{
	if(m_bNoPlayerRangeLimit)
		return true;
        ...
        if (m_uiWPWaitTimer <= uiDiff)
        {
            ...
            if (CurrentWP == WaypointList.end())
            {
                ...
                if (m_bCanReturnToStart)
                {
                    ...
                    m_creature->GetMotionMaster()->MovePoint(POINT_HOME, fRetX, fRetY, fRetZ, !m_bIgnorePathing);
            ...
            {
                m_creature->GetMotionMaster()->MovePoint(CurrentWP->uiId, CurrentWP->fX, CurrentWP->fY, CurrentWP->fZ, !m_bIgnorePathing);
