...
enum
{
    ...
    NPC_GUID_GUARD1         = 79345,
    NPC_GUID_GUARD2         = 79346,
    NPC_GUID_KEG_ATTACKER   = 3000648
};
...
class MANGOS_DLL_DECL instance_deadmines : public ScriptedInstance
{
    ...
    protected:
        void CreatureInvestigateDoor(uint32 entry, uint32 creatureGuidCounter, float xTarget, float yTarget, float zTarget);
        void RespawnPatrolMember(uint32 entry, uint32 guidCounter);
