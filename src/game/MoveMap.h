...
namespace MMAP
{
    ...
    class MMapManager
    {
        public:
            ...
            bool GetNearestValidPosition(Unit *queryUnit, float searchX, float searchY, float searchZ, float &outX, float &outY, float &outZ, dtPolyRef *activePoly);
            bool DrawRay(Unit *queryUnit, dtPolyRef unitPoly, float startX, float startY, float startZ, float &endX, float &endY, float &endZ);
        private:
