...
void Spell::EffectDummy(SpellEffectIndex eff_idx)
{
    ...
    case SPELLFAMILY_GENERIC:
    {
        ...
        case 1661:
        {
            ...
            // melee, ranged and cast time reduction should be same for all the three
...
void Spell::EffectAddExtraAttacks(SpellEffectIndex /*eff_idx*/)
{
    ...
    {
        if (unitTarget->m_extraAttacks > 0 && m_caster->getVictim())
        {
...
void Spell::EffectSummonDeadPet(SpellEffectIndex /*eff_idx*/)
{
    ...
    float x,y,z;
    m_caster->GetClosePoint(x, y, z, 1, 1);
    pet->NearTeleportTo(x,y,z + 0.5f, m_caster->GetOrientation());
