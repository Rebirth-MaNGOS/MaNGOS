...
class ScriptMgr
{
    public:
		...
		uint32 GetVendorId(Player *pPlayer, Creature const* pCreature) const;
        uint32 GetDialogStatus(Player* pPlayer, Creature* pCreature);
        uint32 GetDialogStatus(Player* pPlayer, GameObject* pGameObject);
        bool OnGameObjectUse(Player* pPlayer, GameObject* pGameObject);
		bool OnMobGameObjectUse(Creature* pMob, GameObject* pGameObject);
    ...
    private:
		...
		uint32 (MANGOS_IMPORT* m_pGetNPCVendorId) (Player*, Creature const*);
		...
		bool (MANGOS_IMPORT* m_pOnMobGOUse)(Creature*, GameObject*);
		...
		DatabaseType *(MANGOS_IMPORT* m_pGetScriptdevDB) ();
};
