...
#define SPELL_ATTR_HIDDEN                         0x00000080            // 7 Generally used for talents to provide hidden buffs to players
...
#define SPELL_ATTR_HEARTBEAT_RESIST               0x40000000            // 30 Every 10% of the duration, roll hit again and break aura if fails
...
#define SPELL_ATTR_EX4_SPELL_VS_EXTEND_COST       0x00000400            // 10
...
enum PartialResistInfo
{
	PARTIAL_RESIST_NONE				= 0,
	PARTIAL_RESIST_25PCT			= 1,
	PARTIAL_RESIST_50PCT			= 2,
	PARTIAL_RESIST_75PCT			= 3,
	PARTIAL_RESIST_TOTAL			= 4
};
...
enum DiminishingGroup
{
    ...
    DIMINISHING_FEAR,                                       // All fears
    DIMINISHING_CHARM,
    DIMINISHING_POLYMORPH,
    DIMINISHING_OPENER_STUN,                                // Kidney Shot is not diminished with Cheap Shot
    DIMINISHING_SCATTER,                                    // Hunter's Freezing Trap
    DIMINISHING_INCAPACITATE,                               // Also with Sap, all Knockout mechanics are here
    DIMINISHING_BANISH
};
