...
class LootTemplate
{
    ...
    public:
        ...
        void Process(Player *player, Loot& loot, LootStore const& store, bool rate, uint32 currentDepth=0, uint8 GroupId = 0) const;

        // True if template includes at least 1 quest drop entry
        bool HasQuestDrop(LootTemplateMap const& store, uint32 currentDepth=0, uint8 GroupId = 0) const;
        // True if template includes at least 1 quest drop for an active quest of the player
        bool HasQuestDropForPlayer(LootTemplateMap const& store, Player const * player, uint32 currentDepth=0, uint8 GroupId = 0) const;
