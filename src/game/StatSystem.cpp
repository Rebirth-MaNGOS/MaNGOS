...
void Player::UpdateManaRegen()
{
    ...
    float power_regen = OCTRegenMPPerSpirit()/2;
...
void Pet::UpdateAttackPowerAndDamage(bool ranged)
{
    ...
    {
        if(getPetType() == HUNTER_PET)                      //hunter pets benefit from owner's attack power [-ZERO] set coefficients to 0.0!
        {
        ...
        //demons benefit from warlocks shadow or fire damage [-ZERO] set coefficients to 0.0!
