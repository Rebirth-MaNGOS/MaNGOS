...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand bugReportCommandTable[] =
    {
        ...
        { nullptr,          SEC_PLAYER,         false, &ChatHandler::HandleBugReportCount,                 "", nullptr }
    };
    ...
    static ChatCommand lookupPlayerCommandTable[] =
    {
		...
		{ "ipall",          SEC_GAMEMASTER,     true,  &ChatHandler::HandleLookupPlayerIpAllCommand,   "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
    ...
    static ChatCommand mmapCommandTable[] =
    {
		...
		{ "addpoint",		SEC_GAMEMASTER,		false, &ChatHandler::HandleMmapAddPointCommand,		   "", NULL },
		{ "generatepolyfile", SEC_GAMEMASTER,	false, &ChatHandler::HandleMmapGeneratePolyFileCommand,"", NULL },
    ...
    static ChatCommand npcCommandTable[] =
    {
		...
		{ "addbgcreatures", SEC_ADMINISTRATOR,  false, &ChatHandler::HandleAddBGCreatureCommand,       "", NULL },
		...
		{ "addwaypoint",	SEC_GAMEMASTER,		false, &ChatHandler::HandleAddSDZCreatureWaypoint,	   "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
		...
		{ "bgqueue",      SEC_PLAYER,         true,  &ChatHandler::HandleBGQueueCommand,             "", NULL },
