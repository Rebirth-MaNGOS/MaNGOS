...
class MANGOS_DLL_SPEC Pet : public Creature
{
    public:
        ...
        bool LoadPetFromDB( Player* owner,uint32 petentry = 0,uint32 petnumber = 0, bool current = false,
               bool expectedDead = false );
        static bool IsPetDeadInDB(Player* owner);
		...
		bool IsGiantstalkerBuffApplied() { return m_bGiantstalkerBuffApplied; }
		void SetGiantstalkerBuffApplied(bool applied) { m_bGiantstalkerBuffApplied = applied; }
		bool IsGiantstalkerBuffApplicable(Aura* aura, bool apply);
    ...
    private:
		...
		bool m_bGiantstalkerBuffApplied;
