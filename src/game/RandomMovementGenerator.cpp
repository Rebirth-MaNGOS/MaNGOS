...
{
    float respX, respY, respZ, respO, destX, destY, destZ, wander_distance, travelDistZ;
    ...
    else
    {
		...
		{
			i_nextMoveTime.Reset(i_destinationHolder.GetTotalTravelTime() + urand(2000, 10000));
