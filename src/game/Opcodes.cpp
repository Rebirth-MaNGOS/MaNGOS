...
void Opcodes::BuildOpcodeList()
{
    ...
    /*013*/  StoreOpcode( CMSG_CREATEITEM,                   "CMSG_CREATEITEM",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*014*/  StoreOpcode( CMSG_CREATEGAMEOBJECT,             "CMSG_CREATEGAMEOBJECT",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*015*/  StoreOpcode( SMSG_CHECK_FOR_BOTS,               "SMSG_CHECK_FOR_BOTS",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*016*/  StoreOpcode( CMSG_MAKEMONSTERATTACKGUID,        "CMSG_MAKEMONSTERATTACKGUID",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*017*/  StoreOpcode( CMSG_BOT_DETECTED2,                "CMSG_BOT_DETECTED2",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*018*/  StoreOpcode( CMSG_FORCEACTION,                  "CMSG_FORCEACTION",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*019*/  StoreOpcode( CMSG_FORCEACTIONONOTHER,           "CMSG_FORCEACTIONONOTHER",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*01A*/  StoreOpcode( CMSG_FORCEACTIONSHOW,              "CMSG_FORCEACTIONSHOW",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*01B*/  StoreOpcode( SMSG_FORCEACTIONSHOW,              "SMSG_FORCEACTIONSHOW",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*01C*/  StoreOpcode( CMSG_PETGODMODE,                   "CMSG_PETGODMODE",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*01D*/  StoreOpcode( SMSG_PETGODMODE,                   "SMSG_PETGODMODE",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*01E*/  StoreOpcode( SMSG_DEBUGINFOSPELLMISS_OBSOLETE,  "SMSG_DEBUGINFOSPELLMISS_OBSOLETE", STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*01F*/  StoreOpcode( CMSG_WEATHER_SPEED_CHEAT,          "CMSG_WEATHER_SPEED_CHEAT",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*020*/  StoreOpcode( CMSG_UNDRESSPLAYER,                "CMSG_UNDRESSPLAYER",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*021*/  StoreOpcode( CMSG_BEASTMASTER,                  "CMSG_BEASTMASTER",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*022*/  StoreOpcode( CMSG_GODMODE,                      "CMSG_GODMODE",                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*023*/  StoreOpcode( SMSG_GODMODE,                      "SMSG_GODMODE",                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*024*/  StoreOpcode( CMSG_CHEAT_SETMONEY,               "CMSG_CHEAT_SETMONEY",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*025*/  StoreOpcode( CMSG_LEVEL_CHEAT,                  "CMSG_LEVEL_CHEAT",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*026*/  StoreOpcode( CMSG_PET_LEVEL_CHEAT,              "CMSG_PET_LEVEL_CHEAT",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*027*/  StoreOpcode( CMSG_SET_WORLDSTATE,               "CMSG_SET_WORLDSTATE",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*028*/  StoreOpcode( CMSG_COOLDOWN_CHEAT,               "CMSG_COOLDOWN_CHEAT",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*029*/  StoreOpcode( CMSG_USE_SKILL_CHEAT,              "CMSG_USE_SKILL_CHEAT",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*02A*/  StoreOpcode( CMSG_FLAG_QUEST,                   "CMSG_FLAG_QUEST",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*02B*/  StoreOpcode( CMSG_FLAG_QUEST_FINISH,            "CMSG_FLAG_QUEST_FINISH",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*02C*/  StoreOpcode( CMSG_CLEAR_QUEST,                  "CMSG_CLEAR_QUEST",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*02D*/  StoreOpcode( CMSG_SEND_EVENT,                   "CMSG_SEND_EVENT",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*02E*/  StoreOpcode( CMSG_DEBUG_AISTATE,                "CMSG_DEBUG_AISTATE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*02F*/  StoreOpcode( SMSG_DEBUG_AISTATE,                "SMSG_DEBUG_AISTATE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*030*/  StoreOpcode( CMSG_DISABLE_PVP_CHEAT,            "CMSG_DISABLE_PVP_CHEAT",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*031*/  StoreOpcode( CMSG_ADVANCE_SPAWN_TIME,           "CMSG_ADVANCE_SPAWN_TIME",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*032*/  StoreOpcode( CMSG_PVP_PORT_OBSOLETE,            "CMSG_PVP_PORT_OBSOLETE",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*033*/  StoreOpcode( CMSG_AUTH_SRP6_BEGIN,              "CMSG_AUTH_SRP6_BEGIN",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*034*/  StoreOpcode( CMSG_AUTH_SRP6_PROOF,              "CMSG_AUTH_SRP6_PROOF",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*035*/  StoreOpcode( CMSG_AUTH_SRP6_RECODE,             "CMSG_AUTH_SRP6_RECODE",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*036*/  StoreOpcode( CMSG_CHAR_CREATE,                  "CMSG_CHAR_CREATE",                 STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharCreateOpcode           );
    /*037*/  StoreOpcode( CMSG_CHAR_ENUM,                    "CMSG_CHAR_ENUM",                   STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharEnumOpcode             );
    /*038*/  StoreOpcode( CMSG_CHAR_DELETE,                  "CMSG_CHAR_DELETE",                 STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharDeleteOpcode           );
    /*039*/  StoreOpcode( SMSG_AUTH_SRP6_RESPONSE,           "SMSG_AUTH_SRP6_RESPONSE",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*03A*/  StoreOpcode( SMSG_CHAR_CREATE,                  "SMSG_CHAR_CREATE",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*03B*/  StoreOpcode( SMSG_CHAR_ENUM,                    "SMSG_CHAR_ENUM",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*03C*/  StoreOpcode( SMSG_CHAR_DELETE,                  "SMSG_CHAR_DELETE",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*03D*/  StoreOpcode( CMSG_PLAYER_LOGIN,                 "CMSG_PLAYER_LOGIN",                STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandlePlayerLoginOpcode          );
    ...
    /*044*/  StoreOpcode( CMSG_GAMETIME_SET,                 "CMSG_GAMETIME_SET",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*046*/  StoreOpcode( CMSG_GAMESPEED_SET,                "CMSG_GAMESPEED_SET",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*048*/  StoreOpcode( CMSG_SERVERTIME,                   "CMSG_SERVERTIME",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*056*/  StoreOpcode( CMSG_ITEM_QUERY_SINGLE,            "CMSG_ITEM_QUERY_SINGLE",           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleItemQuerySingleOpcode      );
    /*057*/  StoreOpcode( CMSG_ITEM_QUERY_MULTIPLE,          "CMSG_ITEM_QUERY_MULTIPLE",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*062*/  StoreOpcode( CMSG_WHO,                          "CMSG_WHO",                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleWhoOpcode                  );
    /*063*/  StoreOpcode( SMSG_WHO,                          "SMSG_WHO",                         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*066*/  StoreOpcode( CMSG_FRIEND_LIST,                  "CMSG_FRIEND_LIST",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleFriendListOpcode           );
    /*067*/  StoreOpcode( SMSG_FRIEND_LIST,                  "SMSG_FRIEND_LIST",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*068*/  StoreOpcode( SMSG_FRIEND_STATUS,                "SMSG_FRIEND_STATUS",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*069*/  StoreOpcode( CMSG_ADD_FRIEND,                   "CMSG_ADD_FRIEND",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddFriendOpcode            );
    /*06A*/  StoreOpcode( CMSG_DEL_FRIEND,                   "CMSG_DEL_FRIEND",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDelFriendOpcode            );
    /*06B*/  StoreOpcode( SMSG_IGNORE_LIST,                  "SMSG_IGNORE_LIST",                 STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide                );
    /*06C*/  StoreOpcode( CMSG_ADD_IGNORE,                   "CMSG_ADD_IGNORE",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddIgnoreOpcode            );
    /*06D*/  StoreOpcode( CMSG_DEL_IGNORE,                   "CMSG_DEL_IGNORE",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDelIgnoreOpcode            );
    ...
    /*070*/  StoreOpcode( CMSG_GROUP_CANCEL,                 "CMSG_GROUP_CANCEL",                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*07D*/  StoreOpcode( SMSG_GROUP_LIST,                   "SMSG_GROUP_LIST",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*080*/  StoreOpcode( UMSG_UPDATE_GROUP_MEMBERS,         "UMSG_UPDATE_GROUP_MEMBERS",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*094*/  StoreOpcode( UMSG_UPDATE_GUILD,                 "UMSG_UPDATE_GUILD",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*095*/  StoreOpcode( CMSG_MESSAGECHAT,                  "CMSG_MESSAGECHAT",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode          );
    /*096*/  StoreOpcode( SMSG_MESSAGECHAT,                  "SMSG_MESSAGECHAT",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*0AB*/  StoreOpcode( CMSG_USE_ITEM,                     "CMSG_USE_ITEM",                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUseItemOpcode              );
    ...
    /*0B2*/  StoreOpcode( CMSG_GAMEOBJ_CHAIR_USE_OBSOLETE,   "CMSG_GAMEOBJ_CHAIR_USE_OBSOLETE",  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*0B5*/  StoreOpcode( MSG_MOVE_START_FORWARD,            "MSG_MOVE_START_FORWARD",           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0B6*/  StoreOpcode( MSG_MOVE_START_BACKWARD,           "MSG_MOVE_START_BACKWARD",          STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0B7*/  StoreOpcode( MSG_MOVE_STOP,                     "MSG_MOVE_STOP",                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0B8*/  StoreOpcode( MSG_MOVE_START_STRAFE_LEFT,        "MSG_MOVE_START_STRAFE_LEFT",       STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0B9*/  StoreOpcode( MSG_MOVE_START_STRAFE_RIGHT,       "MSG_MOVE_START_STRAFE_RIGHT",      STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0BA*/  StoreOpcode( MSG_MOVE_STOP_STRAFE,              "MSG_MOVE_STOP_STRAFE",             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0BB*/  StoreOpcode( MSG_MOVE_JUMP,                     "MSG_MOVE_JUMP",                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0BC*/  StoreOpcode( MSG_MOVE_START_TURN_LEFT,          "MSG_MOVE_START_TURN_LEFT",         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0BD*/  StoreOpcode( MSG_MOVE_START_TURN_RIGHT,         "MSG_MOVE_START_TURN_RIGHT",        STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0BE*/  StoreOpcode( MSG_MOVE_STOP_TURN,                "MSG_MOVE_STOP_TURN",               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0BF*/  StoreOpcode( MSG_MOVE_START_PITCH_UP,           "MSG_MOVE_START_PITCH_UP",          STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0C0*/  StoreOpcode( MSG_MOVE_START_PITCH_DOWN,         "MSG_MOVE_START_PITCH_DOWN",        STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0C1*/  StoreOpcode( MSG_MOVE_STOP_PITCH,               "MSG_MOVE_STOP_PITCH",              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0C2*/  StoreOpcode( MSG_MOVE_SET_RUN_MODE,             "MSG_MOVE_SET_RUN_MODE",            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0C3*/  StoreOpcode( MSG_MOVE_SET_WALK_MODE,            "MSG_MOVE_SET_WALK_MODE",           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0C4*/  StoreOpcode( MSG_MOVE_TOGGLE_LOGGING,           "MSG_MOVE_TOGGLE_LOGGING",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0C5*/  StoreOpcode( MSG_MOVE_TELEPORT,                 "MSG_MOVE_TELEPORT",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0C6*/  StoreOpcode( MSG_MOVE_TELEPORT_CHEAT,           "MSG_MOVE_TELEPORT_CHEAT",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0C7*/  StoreOpcode( MSG_MOVE_TELEPORT_ACK,             "MSG_MOVE_TELEPORT_ACK",            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveTeleportAckOpcode      );
    /*0C8*/  StoreOpcode( MSG_MOVE_TOGGLE_FALL_LOGGING,      "MSG_MOVE_TOGGLE_FALL_LOGGING",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0C9*/  StoreOpcode( MSG_MOVE_FALL_LAND,                "MSG_MOVE_FALL_LAND",               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0CA*/  StoreOpcode( MSG_MOVE_START_SWIM,               "MSG_MOVE_START_SWIM",              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0CB*/  StoreOpcode( MSG_MOVE_STOP_SWIM,                "MSG_MOVE_STOP_SWIM",               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0CC*/  StoreOpcode( MSG_MOVE_SET_RUN_SPEED_CHEAT,      "MSG_MOVE_SET_RUN_SPEED_CHEAT",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0CD*/  StoreOpcode( MSG_MOVE_SET_RUN_SPEED,            "MSG_MOVE_SET_RUN_SPEED",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0CE*/  StoreOpcode( MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT, "MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT",STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0CF*/  StoreOpcode( MSG_MOVE_SET_RUN_BACK_SPEED,       "MSG_MOVE_SET_RUN_BACK_SPEED",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D0*/  StoreOpcode( MSG_MOVE_SET_WALK_SPEED_CHEAT,     "MSG_MOVE_SET_WALK_SPEED_CHEAT",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D1*/  StoreOpcode( MSG_MOVE_SET_WALK_SPEED,           "MSG_MOVE_SET_WALK_SPEED",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D2*/  StoreOpcode( MSG_MOVE_SET_SWIM_SPEED_CHEAT,     "MSG_MOVE_SET_SWIM_SPEED_CHEAT",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D3*/  StoreOpcode( MSG_MOVE_SET_SWIM_SPEED,           "MSG_MOVE_SET_SWIM_SPEED",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D4*/  StoreOpcode( MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT,"MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D5*/  StoreOpcode( MSG_MOVE_SET_SWIM_BACK_SPEED,      "MSG_MOVE_SET_SWIM_BACK_SPEED",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D6*/  StoreOpcode( MSG_MOVE_SET_ALL_SPEED_CHEAT,      "MSG_MOVE_SET_ALL_SPEED_CHEAT",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0D7*/  StoreOpcode( MSG_MOVE_SET_TURN_RATE_CHEAT,      "MSG_MOVE_SET_TURN_RATE_CHEAT",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*0D9*/  StoreOpcode( MSG_MOVE_TOGGLE_COLLISION_CHEAT,   "MSG_MOVE_TOGGLE_COLLISION_CHEAT",  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0DA*/  StoreOpcode( MSG_MOVE_SET_FACING,               "MSG_MOVE_SET_FACING",              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0DB*/  StoreOpcode( MSG_MOVE_SET_PITCH,                "MSG_MOVE_SET_PITCH",               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    /*0DC*/  StoreOpcode( MSG_MOVE_WORLDPORT_ACK,            "MSG_MOVE_WORLDPORT_ACK",           STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveWorldportAckOpcode     );
    /*0DD*/  StoreOpcode( SMSG_MONSTER_MOVE,                 "SMSG_MONSTER_MOVE",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0DE*/  StoreOpcode( SMSG_MOVE_WATER_WALK,              "SMSG_MOVE_WATER_WALK",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0DF*/  StoreOpcode( SMSG_MOVE_LAND_WALK,               "SMSG_MOVE_LAND_WALK",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0E0*/  StoreOpcode( MSG_MOVE_SET_RAW_POSITION_ACK,     "MSG_MOVE_SET_RAW_POSITION_ACK",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0E1*/  StoreOpcode( CMSG_MOVE_SET_RAW_POSITION,        "CMSG_MOVE_SET_RAW_POSITION",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0E2*/  StoreOpcode( SMSG_FORCE_RUN_SPEED_CHANGE,       "SMSG_FORCE_RUN_SPEED_CHANGE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0E3*/  StoreOpcode( CMSG_FORCE_RUN_SPEED_CHANGE_ACK,   "CMSG_FORCE_RUN_SPEED_CHANGE_ACK",  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAckOpcodes );
    /*0E4*/  StoreOpcode( SMSG_FORCE_RUN_BACK_SPEED_CHANGE,  "SMSG_FORCE_RUN_BACK_SPEED_CHANGE", STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0E5*/  StoreOpcode( CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK,"CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK",STATUS_LOGGEDIN,PROCESS_THREADSAFE,&WorldSession::HandleForceSpeedChangeAckOpcodes );
    /*0E6*/  StoreOpcode( SMSG_FORCE_SWIM_SPEED_CHANGE,      "SMSG_FORCE_SWIM_SPEED_CHANGE",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0E7*/  StoreOpcode( CMSG_FORCE_SWIM_SPEED_CHANGE_ACK,  "CMSG_FORCE_SWIM_SPEED_CHANGE_ACK", STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAckOpcodes );
    /*0E8*/  StoreOpcode( SMSG_FORCE_MOVE_ROOT,              "SMSG_FORCE_MOVE_ROOT",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0E9*/  StoreOpcode( CMSG_FORCE_MOVE_ROOT_ACK,          "CMSG_FORCE_MOVE_ROOT_ACK",         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveRootAck                );
    /*0EA*/  StoreOpcode( SMSG_FORCE_MOVE_UNROOT,            "SMSG_FORCE_MOVE_UNROOT",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0EB*/  StoreOpcode( CMSG_FORCE_MOVE_UNROOT_ACK,        "CMSG_FORCE_MOVE_UNROOT_ACK",       STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveUnRootAck              );
    /*0EC*/  StoreOpcode( MSG_MOVE_ROOT,                     "MSG_MOVE_ROOT",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0ED*/  StoreOpcode( MSG_MOVE_UNROOT,                   "MSG_MOVE_UNROOT",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0EE*/  StoreOpcode( MSG_MOVE_HEARTBEAT,                "MSG_MOVE_HEARTBEAT",               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    ...
    /*0F2*/  StoreOpcode( SMSG_MOVE_FEATHER_FALL,            "SMSG_MOVE_FEATHER_FALL",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0F3*/  StoreOpcode( SMSG_MOVE_NORMAL_FALL,             "SMSG_MOVE_NORMAL_FALL",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0F4*/  StoreOpcode( SMSG_MOVE_SET_HOVER,               "SMSG_MOVE_SET_HOVER",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0F5*/  StoreOpcode( SMSG_MOVE_UNSET_HOVER,             "SMSG_MOVE_UNSET_HOVER",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0F6*/  StoreOpcode( CMSG_MOVE_HOVER_ACK,               "CMSG_MOVE_HOVER_ACK",              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveHoverAck               );
    /*0F7*/  StoreOpcode( MSG_MOVE_HOVER,                    "MSG_MOVE_HOVER",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0F8*/  StoreOpcode( CMSG_TRIGGER_CINEMATIC_CHEAT,      "CMSG_TRIGGER_CINEMATIC_CHEAT",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0F9*/  StoreOpcode( CMSG_OPENING_CINEMATIC,            "CMSG_OPENING_CINEMATIC",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*0FA*/  StoreOpcode( SMSG_TRIGGER_CINEMATIC,            "SMSG_TRIGGER_CINEMATIC",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0FB*/  StoreOpcode( CMSG_NEXT_CINEMATIC_CAMERA,        "CMSG_NEXT_CINEMATIC_CAMERA",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNextCinematicCamera        );
    /*0FC*/  StoreOpcode( CMSG_COMPLETE_CINEMATIC,           "CMSG_COMPLETE_CINEMATIC",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCompleteCinematic          );
    /*0FD*/  StoreOpcode( SMSG_TUTORIAL_FLAGS,               "SMSG_TUTORIAL_FLAGS",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*0FE*/  StoreOpcode( CMSG_TUTORIAL_FLAG,                "CMSG_TUTORIAL_FLAG",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTutorialFlagOpcode         );
    /*0FF*/  StoreOpcode( CMSG_TUTORIAL_CLEAR,               "CMSG_TUTORIAL_CLEAR",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTutorialClearOpcode        );
    /*100*/  StoreOpcode( CMSG_TUTORIAL_RESET,               "CMSG_TUTORIAL_RESET",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTutorialResetOpcode        );
    /*101*/  StoreOpcode( CMSG_STANDSTATECHANGE,             "CMSG_STANDSTATECHANGE",            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleStandStateChangeOpcode     );
    ...
    /*106*/  StoreOpcode( CMSG_AUTOEQUIP_GROUND_ITEM,        "CMSG_AUTOEQUIP_GROUND_ITEM",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*107*/  StoreOpcode( CMSG_AUTOSTORE_GROUND_ITEM,        "CMSG_AUTOSTORE_GROUND_ITEM",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*108*/  StoreOpcode( CMSG_AUTOSTORE_LOOT_ITEM,          "CMSG_AUTOSTORE_LOOT_ITEM",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutostoreLootItemOpcode    );
    /*109*/  StoreOpcode( CMSG_STORE_LOOT_IN_SLOT,           "CMSG_STORE_LOOT_IN_SLOT",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*10A*/  StoreOpcode( CMSG_AUTOEQUIP_ITEM,               "CMSG_AUTOEQUIP_ITEM",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoEquipItemOpcode        );
    /*10B*/  StoreOpcode( CMSG_AUTOSTORE_BAG_ITEM,           "CMSG_AUTOSTORE_BAG_ITEM",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoStoreBagItemOpcode     );
    /*10C*/  StoreOpcode( CMSG_SWAP_ITEM,                    "CMSG_SWAP_ITEM",                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSwapItem                   );
    /*10D*/  StoreOpcode( CMSG_SWAP_INV_ITEM,                "CMSG_SWAP_INV_ITEM",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSwapInvItemOpcode          );
    /*10E*/  StoreOpcode( CMSG_SPLIT_ITEM,                   "CMSG_SPLIT_ITEM",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSplitItemOpcode            );
    /*10F*/  StoreOpcode( CMSG_AUTOEQUIP_ITEM_SLOT,          "CMSG_AUTOEQUIP_ITEM_SLOT",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoEquipItemSlotOpcode    );
    /*110*/  StoreOpcode( OBSOLETE_DROP_ITEM,                "OBSOLETE_DROP_ITEM",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*111*/  StoreOpcode( CMSG_DESTROYITEM,                  "CMSG_DESTROYITEM",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDestroyItemOpcode          );
    /*112*/  StoreOpcode( SMSG_INVENTORY_CHANGE_FAILURE,     "SMSG_INVENTORY_CHANGE_FAILURE",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*114*/  StoreOpcode( CMSG_INSPECT,                      "CMSG_INSPECT",                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInspectOpcode              );
    /*115*/  StoreOpcode( SMSG_INSPECT,                      "SMSG_INSPECT",                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*122*/  StoreOpcode( SMSG_INITIALIZE_FACTIONS,          "SMSG_INITIALIZE_FACTIONS",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*123*/  StoreOpcode( SMSG_SET_FACTION_VISIBLE,          "SMSG_SET_FACTION_VISIBLE",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*124*/  StoreOpcode( SMSG_SET_FACTION_STANDING,         "SMSG_SET_FACTION_STANDING",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*125*/  StoreOpcode( CMSG_SET_FACTION_ATWAR,            "CMSG_SET_FACTION_ATWAR",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetFactionAtWarOpcode      );
    /*126*/  StoreOpcode( CMSG_SET_FACTION_CHEAT,            "CMSG_SET_FACTION_CHEAT",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_Deprecated                );
    /*127*/  StoreOpcode( SMSG_SET_PROFICIENCY,              "SMSG_SET_PROFICIENCY",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*128*/  StoreOpcode( CMSG_SET_ACTION_BUTTON,            "CMSG_SET_ACTION_BUTTON",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionButtonOpcode      );
    /*129*/  StoreOpcode( SMSG_ACTION_BUTTONS,               "SMSG_ACTION_BUTTONS",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*12A*/  StoreOpcode( SMSG_INITIAL_SPELLS,               "SMSG_INITIAL_SPELLS",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*12B*/  StoreOpcode( SMSG_LEARNED_SPELL,                "SMSG_LEARNED_SPELL",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*12C*/  StoreOpcode( SMSG_SUPERCEDED_SPELL,             "SMSG_SUPERCEDED_SPELL",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*12D*/  StoreOpcode( CMSG_NEW_SPELL_SLOT,               "CMSG_NEW_SPELL_SLOT",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*12E*/  StoreOpcode( CMSG_CAST_SPELL,                   "CMSG_CAST_SPELL",                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleCastSpellOpcode            );
    /*12F*/  StoreOpcode( CMSG_CANCEL_CAST,                  "CMSG_CANCEL_CAST",                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleCancelCastOpcode           );
    ...
    /*131*/  StoreOpcode( SMSG_SPELL_START,                  "SMSG_SPELL_START",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*132*/  StoreOpcode( SMSG_SPELL_GO,                     "SMSG_SPELL_GO",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*134*/  StoreOpcode( SMSG_SPELL_COOLDOWN,               "SMSG_SPELL_COOLDOWN",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*139*/  StoreOpcode( MSG_CHANNEL_START,                 "MSG_CHANNEL_START",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*13A*/  StoreOpcode( MSG_CHANNEL_UPDATE,                "MSG_CHANNEL_UPDATE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*13F*/  StoreOpcode( CMSG_UNUSED,                       "CMSG_UNUSED",                      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*140*/  StoreOpcode( CMSG_UNUSED2,                      "CMSG_UNUSED2",                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*145*/  StoreOpcode( SMSG_ATTACKSWING_NOTINRANGE,       "SMSG_ATTACKSWING_NOTINRANGE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*146*/  StoreOpcode( SMSG_ATTACKSWING_BADFACING,        "SMSG_ATTACKSWING_BADFACING",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*147*/  StoreOpcode( SMSG_ATTACKSWING_NOTSTANDING,      "SMSG_ATTACKSWING_NOTSTANDING",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*148*/  StoreOpcode( SMSG_ATTACKSWING_DEADTARGET,       "SMSG_ATTACKSWING_DEADTARGET",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*149*/  StoreOpcode( SMSG_ATTACKSWING_CANT_ATTACK,      "SMSG_ATTACKSWING_CANT_ATTACK",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*152*/  StoreOpcode( CMSG_SHEATHE_OBSOLETE,             "CMSG_SHEATHE_OBSOLETE",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*153*/  StoreOpcode( CMSG_SAVE_PLAYER,                  "CMSG_SAVE_PLAYER",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*154*/  StoreOpcode( CMSG_SETDEATHBINDPOINT,            "CMSG_SETDEATHBINDPOINT",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*156*/  StoreOpcode( CMSG_GETDEATHBINDZONE,             "CMSG_GETDEATHBINDZONE",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*15B*/  StoreOpcode( SMSG_RESURRECT_REQUEST,            "SMSG_RESURRECT_REQUEST",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*15C*/  StoreOpcode( CMSG_RESURRECT_RESPONSE,           "CMSG_RESURRECT_RESPONSE",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleResurrectResponseOpcode    );
    ...
    /*1A6*/  StoreOpcode( CMSG_TAXICLEARALLNODES,            "CMSG_TAXICLEARALLNODES",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1A7*/  StoreOpcode( CMSG_TAXIENABLEALLNODES,           "CMSG_TAXIENABLEALLNODES",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1A8*/  StoreOpcode( CMSG_TAXISHOWNODES,                "CMSG_TAXISHOWNODES",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*1B8*/  StoreOpcode( SMSG_SHOW_BANK,                    "SMSG_SHOW_BANK",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1B9*/  StoreOpcode( CMSG_BUY_BANK_SLOT,                "CMSG_BUY_BANK_SLOT",               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleBuyBankSlotOpcode          );
    /*1BA*/  StoreOpcode( SMSG_BUY_BANK_SLOT_RESULT,         "SMSG_BUY_BANK_SLOT_RESULT",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*1D2*/  StoreOpcode( CMSG_RECLAIM_CORPSE,               "CMSG_RECLAIM_CORPSE",              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleReclaimCorpseOpcode        );
    ...
    /*1D8*/  StoreOpcode( CMSG_SET_SKILL_CHEAT,              "CMSG_SET_SKILL_CHEAT",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*1E1*/  StoreOpcode( SMSG_COOLDOWN_CHEAT,               "SMSG_COOLDOWN_CHEAT",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1E2*/  StoreOpcode( SMSG_SPELL_DELAYED,                "SMSG_SPELL_DELAYED",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1E3*/  StoreOpcode( CMSG_PLAYER_MACRO_OBSOLETE,        "CMSG_PLAYER_MACRO_OBSOLETE",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1E4*/  StoreOpcode( SMSG_PLAYER_MACRO_OBSOLETE,        "SMSG_PLAYER_MACRO_OBSOLETE",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1E5*/  StoreOpcode( CMSG_GHOST,                        "CMSG_GHOST",                       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1E6*/  StoreOpcode( CMSG_GM_INVIS,                     "CMSG_GM_INVIS",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*1E8*/  StoreOpcode( MSG_GM_BIND_OTHER,                 "MSG_GM_BIND_OTHER",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1E9*/  StoreOpcode( MSG_GM_SUMMON,                     "MSG_GM_SUMMON",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*1EC*/  StoreOpcode( SMSG_AUTH_CHALLENGE,               "SMSG_AUTH_CHALLENGE",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1ED*/  StoreOpcode( CMSG_AUTH_SESSION,                 "CMSG_AUTH_SESSION",                STATUS_NEVER,     PROCESS_THREADSAFE,   &WorldSession::Handle_EarlyProccess             );
    /*1EE*/  StoreOpcode( SMSG_AUTH_RESPONSE,                "SMSG_AUTH_RESPONSE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1EF*/  StoreOpcode( MSG_GM_SHOWLABEL,                  "MSG_GM_SHOWLABEL",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*1F3*/  StoreOpcode( SMSG_PLAY_SPELL_VISUAL,            "SMSG_PLAY_SPELL_VISUAL",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1F4*/  StoreOpcode( CMSG_ZONEUPDATE,                   "CMSG_ZONEUPDATE",                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleZoneUpdateOpcode           );
    /*1F5*/  StoreOpcode( SMSG_PARTYKILLLOG,                 "SMSG_PARTYKILLLOG",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*1F6*/  StoreOpcode( SMSG_COMPRESSED_UPDATE_OBJECT,     "SMSG_COMPRESSED_UPDATE_OBJECT",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*1F9*/  StoreOpcode( CMSG_GM_SET_SECURITY_GROUP,        "CMSG_GM_SET_SECURITY_GROUP",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1FA*/  StoreOpcode( CMSG_GM_NUKE,                      "CMSG_GM_NUKE",                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1FB*/  StoreOpcode( MSG_RANDOM_ROLL,                   "MSG_RANDOM_ROLL",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRandomRollOpcode           );
    ...
    /*1FD*/  StoreOpcode( CMSG_RWHOIS_OBSOLETE,              "CMSG_RWHOIS_OBSOLETE",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*1FE*/  StoreOpcode( SMSG_RWHOIS,                       "SMSG_RWHOIS",                      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*201*/  StoreOpcode( CMSG_UNLEARN_SPELL,                "CMSG_UNLEARN_SPELL",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*204*/  StoreOpcode( CMSG_DECHARGE,                     "CMSG_DECHARGE",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*20F*/  StoreOpcode( CMSG_GM_TEACH,                     "CMSG_GM_TEACH",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*210*/  StoreOpcode( CMSG_GM_CREATE_ITEM_TARGET,        "CMSG_GM_CREATE_ITEM_TARGET",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*213*/  StoreOpcode( CMSG_UNLEARN_TALENTS,              "CMSG_UNLEARN_TALENTS",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*21D*/  StoreOpcode( CMSG_SET_STAT_CHEAT,               "CMSG_SET_STAT_CHEAT",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*21F*/  StoreOpcode( CMSG_SKILL_BUY_STEP,               "CMSG_SKILL_BUY_STEP",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*220*/  StoreOpcode( CMSG_SKILL_BUY_RANK,               "CMSG_SKILL_BUY_RANK",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*221*/  StoreOpcode( CMSG_XP_CHEAT,                     "CMSG_XP_CHEAT",                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*223*/  StoreOpcode( CMSG_CHARACTER_POINT_CHEAT,        "CMSG_CHARACTER_POINT_CHEAT",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*226*/  StoreOpcode( CMSG_GM_VISION,                    "CMSG_GM_VISION",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*227*/  StoreOpcode( CMSG_SERVER_COMMAND,               "CMSG_SERVER_COMMAND",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*228*/  StoreOpcode( CMSG_GM_SILENCE,                   "CMSG_GM_SILENCE",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*229*/  StoreOpcode( CMSG_GM_REVEALTO,                  "CMSG_GM_REVEALTO",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*22A*/  StoreOpcode( CMSG_GM_RESURRECT,                 "CMSG_GM_RESURRECT",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*22B*/  StoreOpcode( CMSG_GM_SUMMONMOB,                 "CMSG_GM_SUMMONMOB",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*22C*/  StoreOpcode( CMSG_GM_MOVECORPSE,                "CMSG_GM_MOVECORPSE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*22D*/  StoreOpcode( CMSG_GM_FREEZE,                    "CMSG_GM_FREEZE",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*22E*/  StoreOpcode( CMSG_GM_UBERINVIS,                 "CMSG_GM_UBERINVIS",                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*22F*/  StoreOpcode( CMSG_GM_REQUEST_PLAYER_INFO,       "CMSG_GM_REQUEST_PLAYER_INFO",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*230*/  StoreOpcode( SMSG_GM_PLAYER_INFO,               "SMSG_GM_PLAYER_INFO",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*237*/  StoreOpcode( CMSG_CLEAR_EXPLORATION,            "CMSG_CLEAR_EXPLORATION",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*23A*/  StoreOpcode( CMSG_GET_MAIL_LIST,                "CMSG_GET_MAIL_LIST",               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetMailList                );
    /*23B*/  StoreOpcode( SMSG_MAIL_LIST_RESULT,             "SMSG_MAIL_LIST_RESULT",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*23E*/  StoreOpcode( CMSG_BATTLEFIELD_JOIN,             "CMSG_BATTLEFIELD_JOIN",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*23F*/  StoreOpcode( SMSG_BATTLEFIELD_WIN_OBSOLETE,     "SMSG_BATTLEFIELD_WIN_OBSOLETE",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*240*/  StoreOpcode( SMSG_BATTLEFIELD_LOSE_OBSOLETE,    "SMSG_BATTLEFIELD_LOSE_OBSOLETE",   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*241*/  StoreOpcode( CMSG_TAXICLEARNODE,                "CMSG_TAXICLEARNODE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*242*/  StoreOpcode( CMSG_TAXIENABLENODE,               "CMSG_TAXIENABLENODE",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*245*/  StoreOpcode( CMSG_MAIL_TAKE_MONEY,              "CMSG_MAIL_TAKE_MONEY",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailTakeMoney              );
    /*246*/  StoreOpcode( CMSG_MAIL_TAKE_ITEM,               "CMSG_MAIL_TAKE_ITEM",              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailTakeItem               );
    /*247*/  StoreOpcode( CMSG_MAIL_MARK_AS_READ,            "CMSG_MAIL_MARK_AS_READ",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailMarkAsRead             );
    /*248*/  StoreOpcode( CMSG_MAIL_RETURN_TO_SENDER,        "CMSG_MAIL_RETURN_TO_SENDER",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailReturnToSender         );
    /*249*/  StoreOpcode( CMSG_MAIL_DELETE,                  "CMSG_MAIL_DELETE",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailDelete                 );
    /*24A*/  StoreOpcode( CMSG_MAIL_CREATE_TEXT_ITEM,        "CMSG_MAIL_CREATE_TEXT_ITEM",       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailCreateTextItem         );
    ...
    /*251*/  StoreOpcode( CMSG_LEARN_TALENT,                 "CMSG_LEARN_TALENT",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLearnTalentOpcode          );
    ...
    /*256*/  StoreOpcode( CMSG_AUCTION_SELL_ITEM,            "CMSG_AUCTION_SELL_ITEM",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionSellItem            );
    /*257*/  StoreOpcode( CMSG_AUCTION_REMOVE_ITEM,          "CMSG_AUCTION_REMOVE_ITEM",         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionRemoveItem          );
    /*258*/  StoreOpcode( CMSG_AUCTION_LIST_ITEMS,           "CMSG_AUCTION_LIST_ITEMS",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionListItems           );
    ...
    /*25A*/  StoreOpcode( CMSG_AUCTION_PLACE_BID,            "CMSG_AUCTION_PLACE_BID",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionPlaceBid            );
    ...
    /*26C*/  StoreOpcode( CMSG_PLAYER_AI_CHEAT,              "CMSG_PLAYER_AI_CHEAT",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*26E*/  StoreOpcode( MSG_GM_ACCOUNT_ONLINE,             "MSG_GM_ACCOUNT_ONLINE",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*26F*/  StoreOpcode( MSG_LIST_STABLED_PETS,             "MSG_LIST_STABLED_PETS",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListStabledPetsOpcode      );
    /*270*/  StoreOpcode( CMSG_STABLE_PET,                   "CMSG_STABLE_PET",                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleStablePet                  );
    ...
    /*275*/  StoreOpcode( CMSG_STABLE_SWAP_PET,              "CMSG_STABLE_SWAP_PET",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleStableSwapPet              );
    ...
    /*27D*/  StoreOpcode( CMSG_ENABLE_DAMAGE_LOG,            "CMSG_ENABLE_DAMAGE_LOG",           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*27F*/  StoreOpcode( CMSG_REQUEST_PARTY_MEMBER_STATS,   "CMSG_REQUEST_PARTY_MEMBER_STATS",  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestPartyMemberStatsOpcode        );
    /*280*/  StoreOpcode( CMSG_GROUP_SWAP_SUB_GROUP,         "CMSG_GROUP_SWAP_SUB_GROUP",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*281*/  StoreOpcode( CMSG_RESET_FACTION_CHEAT,          "CMSG_RESET_FACTION_CHEAT",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*287*/  StoreOpcode( CMSG_SET_DURABILITY_CHEAT,         "CMSG_SET_DURABILITY_CHEAT",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*288*/  StoreOpcode( CMSG_SET_PVP_RANK_CHEAT,           "CMSG_SET_PVP_RANK_CHEAT",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*289*/  StoreOpcode( CMSG_ADD_PVP_MEDAL_CHEAT,          "CMSG_ADD_PVP_MEDAL_CHEAT",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*28A*/  StoreOpcode( CMSG_DEL_PVP_MEDAL_CHEAT,          "CMSG_DEL_PVP_MEDAL_CHEAT",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*28B*/  StoreOpcode( CMSG_SET_PVP_TITLE,                "CMSG_SET_PVP_TITLE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*28E*/  StoreOpcode( CMSG_GROUP_RAID_CONVERT,           "CMSG_GROUP_RAID_CONVERT",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupRaidConvertOpcode     );
    ...
    /*290*/  StoreOpcode( CMSG_BUYBACK_ITEM,                 "CMSG_BUYBACK_ITEM",                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuybackItem                );
    ...
    /*292*/  StoreOpcode( CMSG_MEETINGSTONE_JOIN,            "CMSG_MEETINGSTONE_JOIN",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMeetingStoneJoinOpcode     );
    /*293*/  StoreOpcode( CMSG_MEETINGSTONE_LEAVE,           "CMSG_MEETINGSTONE_LEAVE",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*294*/  StoreOpcode( CMSG_MEETINGSTONE_CHEAT,           "CMSG_MEETINGSTONE_CHEAT",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*29A*/  StoreOpcode( CMSG_GMTICKETSYSTEM_TOGGLE,        "CMSG_GMTICKETSYSTEM_TOGGLE",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*29F*/  StoreOpcode( SMSG_LOOT_ROLL_WON,                "SMSG_LOOT_ROLL_WON",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2A0*/  StoreOpcode( CMSG_LOOT_ROLL,                    "CMSG_LOOT_ROLL",                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootRoll                   );
    /*2A1*/  StoreOpcode( SMSG_LOOT_START_ROLL,              "SMSG_LOOT_START_ROLL",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2A2*/  StoreOpcode( SMSG_LOOT_ROLL,                    "SMSG_LOOT_ROLL",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*2AD*/  StoreOpcode( MSG_MOVE_TOGGLE_GRAVITY_CHEAT,     "MSG_MOVE_TOGGLE_GRAVITY_CHEAT",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*2B0*/  StoreOpcode( MSG_MOVE_FEATHER_FALL,             "MSG_MOVE_FEATHER_FALL",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*2B1*/  StoreOpcode( MSG_MOVE_WATER_WALK,               "MSG_MOVE_WATER_WALK",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*2B2*/  StoreOpcode( CMSG_SERVER_BROADCAST,             "CMSG_SERVER_BROADCAST",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*2B5*/  StoreOpcode( CMSG_RUN_SCRIPT,                   "CMSG_RUN_SCRIPT",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*2B7*/  StoreOpcode( SMSG_DUEL_COUNTDOWN,               "SMSG_DUEL_COUNTDOWN",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*2BE*/  StoreOpcode( CMSG_SET_EXPLORATION,              "CMSG_SET_EXPLORATION",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*2BF*/  StoreOpcode( CMSG_SET_ACTIONBAR_TOGGLES,        "CMSG_SET_ACTIONBAR_TOGGLES",       STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionBarTogglesOpcode  );
    /*2C0*/  StoreOpcode( UMSG_DELETE_GUILD_CHARTER,         "UMSG_DELETE_GUILD_CHARTER",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*2CA*/  StoreOpcode( CMSG_MOVE_FALL_RESET,              "CMSG_MOVE_FALL_RESET",             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes            );
    ...
    /*2CC*/  StoreOpcode( SMSG_RAID_INSTANCE_INFO,           "SMSG_RAID_INSTANCE_INFO",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2CD*/  StoreOpcode( CMSG_REQUEST_RAID_INFO,            "CMSG_REQUEST_RAID_INFO",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestRaidInfoOpcode      );
    ...
    /*2CF*/  StoreOpcode( CMSG_MOVE_FEATHER_FALL_ACK,        "CMSG_MOVE_FEATHER_FALL_ACK",       STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleFeatherFallAck             );
    /*2D0*/  StoreOpcode( CMSG_MOVE_WATER_WALK_ACK,          "CMSG_MOVE_WATER_WALK_ACK",         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveWaterWalkAck           );
    /*2D1*/  StoreOpcode( CMSG_MOVE_NOT_ACTIVE_MOVER,        "CMSG_MOVE_NOT_ACTIVE_MOVER",       STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveNotActiveMoverOpcode   );
    ...
    /*2D3*/  StoreOpcode( CMSG_BATTLEFIELD_STATUS,           "CMSG_BATTLEFIELD_STATUS",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlefieldStatusOpcode    );
    /*2D4*/  StoreOpcode( SMSG_BATTLEFIELD_STATUS,           "SMSG_BATTLEFIELD_STATUS",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2D5*/  StoreOpcode( CMSG_BATTLEFIELD_PORT,             "CMSG_BATTLEFIELD_PORT",            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattleFieldPortOpcode      );
    /*2D6*/  StoreOpcode( MSG_INSPECT_HONOR_STATS,           "MSG_INSPECT_HONOR_STATS",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInspectHonorStatsOpcode    );
    /*2D7*/  StoreOpcode( CMSG_BATTLEMASTER_HELLO,           "CMSG_BATTLEMASTER_HELLO",          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterHelloOpcode    );
    /*2D8*/  StoreOpcode( CMSG_MOVE_START_SWIM_CHEAT,        "CMSG_MOVE_START_SWIM_CHEAT",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*2D9*/  StoreOpcode( CMSG_MOVE_STOP_SWIM_CHEAT,         "CMSG_MOVE_STOP_SWIM_CHEAT",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*2DA*/  StoreOpcode( SMSG_FORCE_WALK_SPEED_CHANGE,      "SMSG_FORCE_WALK_SPEED_CHANGE",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2DB*/  StoreOpcode( CMSG_FORCE_WALK_SPEED_CHANGE_ACK,  "CMSG_FORCE_WALK_SPEED_CHANGE_ACK", STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAckOpcodes );
    /*2DC*/  StoreOpcode( SMSG_FORCE_SWIM_BACK_SPEED_CHANGE, "SMSG_FORCE_SWIM_BACK_SPEED_CHANGE",STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2DD*/  StoreOpcode( CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK,  "CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK",   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAckOpcodes );
    /*2DE*/  StoreOpcode( SMSG_FORCE_TURN_RATE_CHANGE,       "SMSG_FORCE_TURN_RATE_CHANGE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2DF*/  StoreOpcode( CMSG_FORCE_TURN_RATE_CHANGE_ACK,   "CMSG_FORCE_TURN_RATE_CHANGE_ACK",  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAckOpcodes );
    /*2E0*/  StoreOpcode( MSG_PVP_LOG_DATA,                  "MSG_PVP_LOG_DATA",                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePVPLogDataOpcode           );
    /*2E1*/  StoreOpcode( CMSG_LEAVE_BATTLEFIELD,            "CMSG_LEAVE_BATTLEFIELD",           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLeaveBattlefieldOpcode     );
    ...
    /*2E5*/  StoreOpcode( CMSG_GM_UNTEACH,                   "CMSG_GM_UNTEACH",                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*2E6*/  StoreOpcode(SMSG_WARDEN_DATA,                  "SMSG_WARDEN_DATA",                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    /*2E7*/  StoreOpcode(CMSG_WARDEN_DATA,                  "CMSG_WARDEN_DATA",                 STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleWardenDataOpcode);
    ...
    /*2EA*/  StoreOpcode( CMSG_PET_STOP_ATTACK,              "CMSG_PET_STOP_ATTACK",             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetStopAttack              );
    ...
    /*2F6*/  StoreOpcode( SMSG_MINIGAME_SETUP,               "SMSG_MINIGAME_SETUP",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2F7*/  StoreOpcode( SMSG_MINIGAME_STATE,               "SMSG_MINIGAME_STATE",              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2F8*/  StoreOpcode( CMSG_MINIGAME_MOVE,                "CMSG_MINIGAME_MOVE",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*2F9*/  StoreOpcode( SMSG_MINIGAME_MOVE_FAILED,         "SMSG_MINIGAME_MOVE_FAILED",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*2FE*/  StoreOpcode( SMSG_SPLINE_SET_RUN_SPEED,         "SMSG_SPLINE_SET_RUN_SPEED",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*2FF*/  StoreOpcode( SMSG_SPLINE_SET_RUN_BACK_SPEED,    "SMSG_SPLINE_SET_RUN_BACK_SPEED",   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*300*/  StoreOpcode( SMSG_SPLINE_SET_SWIM_SPEED,        "SMSG_SPLINE_SET_SWIM_SPEED",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*301*/  StoreOpcode( SMSG_SPLINE_SET_WALK_SPEED,        "SMSG_SPLINE_SET_WALK_SPEED",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*302*/  StoreOpcode( SMSG_SPLINE_SET_SWIM_BACK_SPEED,   "SMSG_SPLINE_SET_SWIM_BACK_SPEED",  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*303*/  StoreOpcode( SMSG_SPLINE_SET_TURN_RATE,         "SMSG_SPLINE_SET_TURN_RATE",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*304*/  StoreOpcode( SMSG_SPLINE_MOVE_UNROOT,           "SMSG_SPLINE_MOVE_UNROOT",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*305*/  StoreOpcode( SMSG_SPLINE_MOVE_FEATHER_FALL,     "SMSG_SPLINE_MOVE_FEATHER_FALL",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*306*/  StoreOpcode( SMSG_SPLINE_MOVE_NORMAL_FALL,      "SMSG_SPLINE_MOVE_NORMAL_FALL",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*307*/  StoreOpcode( SMSG_SPLINE_MOVE_SET_HOVER,        "SMSG_SPLINE_MOVE_SET_HOVER",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*308*/  StoreOpcode( SMSG_SPLINE_MOVE_UNSET_HOVER,      "SMSG_SPLINE_MOVE_UNSET_HOVER",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*309*/  StoreOpcode( SMSG_SPLINE_MOVE_WATER_WALK,       "SMSG_SPLINE_MOVE_WATER_WALK",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*30A*/  StoreOpcode( SMSG_SPLINE_MOVE_LAND_WALK,        "SMSG_SPLINE_MOVE_LAND_WALK",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*30B*/  StoreOpcode( SMSG_SPLINE_MOVE_START_SWIM,       "SMSG_SPLINE_MOVE_START_SWIM",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*30C*/  StoreOpcode( SMSG_SPLINE_MOVE_STOP_SWIM,        "SMSG_SPLINE_MOVE_STOP_SWIM",       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*30D*/  StoreOpcode( SMSG_SPLINE_MOVE_SET_RUN_MODE,     "SMSG_SPLINE_MOVE_SET_RUN_MODE",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*30E*/  StoreOpcode( SMSG_SPLINE_MOVE_SET_WALK_MODE,    "SMSG_SPLINE_MOVE_SET_WALK_MODE",   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*30F*/  StoreOpcode( CMSG_GM_NUKE_ACCOUNT,              "CMSG_GM_NUKE_ACCOUNT",             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*310*/  StoreOpcode( MSG_GM_DESTROY_CORPSE,             "MSG_GM_DESTROY_CORPSE",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*311*/  StoreOpcode( CMSG_GM_DESTROY_ONLINE_CORPSE,     "CMSG_GM_DESTROY_ONLINE_CORPSE",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*315*/  StoreOpcode( CMSG_DEBUG_ACTIONS_START,          "CMSG_DEBUG_ACTIONS_START",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*316*/  StoreOpcode( CMSG_DEBUG_ACTIONS_STOP,           "CMSG_DEBUG_ACTIONS_STOP",          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*319*/  StoreOpcode( MSG_MOVE_TIME_SKIPPED,             "MSG_MOVE_TIME_SKIPPED",            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*31B*/  StoreOpcode( CMSG_SET_EXPLORATION_ALL,          "CMSG_SET_EXPLORATION_ALL",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*323*/  StoreOpcode( CMSG_LUA_USAGE,                    "CMSG_LUA_USAGE",                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*327*/  StoreOpcode( CMSG_GM_UPDATE_TICKET_STATUS,      "CMSG_GM_UPDATE_TICKET_STATUS",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*328*/  StoreOpcode( SMSG_GM_TICKET_STATUS_UPDATE,      "SMSG_GM_TICKET_STATUS_UPDATE",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*32C*/  StoreOpcode( CMSG_IGNORE_KNOCKBACK_CHEAT,       "CMSG_IGNORE_KNOCKBACK_CHEAT",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*32E*/  StoreOpcode( MSG_DELAY_GHOST_TELEPORT,          "MSG_DELAY_GHOST_TELEPORT",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*331*/  StoreOpcode( CMSG_CHAT_FILTERED,                "CMSG_CHAT_FILTERED",               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    /*334*/  StoreOpcode( CMSG_LOTTERY_QUERY_OBSOLETE,       "CMSG_LOTTERY_QUERY_OBSOLETE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*335*/  StoreOpcode( SMSG_LOTTERY_QUERY_RESULT_OBSOLETE,"SMSG_LOTTERY_QUERY_RESULT_OBSOLETE",      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*336*/  StoreOpcode( CMSG_BUY_LOTTERY_TICKET_OBSOLETE,  "CMSG_BUY_LOTTERY_TICKET_OBSOLETE", STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*337*/  StoreOpcode( SMSG_LOTTERY_RESULT_OBSOLETE,      "SMSG_LOTTERY_RESULT_OBSOLETE",     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    ...
    /*33C*/  StoreOpcode( MSG_GM_RESETINSTANCELIMIT,         "MSG_GM_RESETINSTANCELIMIT",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*33E*/  StoreOpcode( SMSG_MOVE_SET_FLIGHT,              "SMSG_MOVE_SET_FLIGHT_OBSOLETE",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*33F*/  StoreOpcode( SMSG_MOVE_UNSET_FLIGHT,            "SMSG_MOVE_UNSET_FLIGHT_OBSOLETE",  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide                );
    /*340*/  StoreOpcode( CMSG_MOVE_FLIGHT_ACK,              "CMSG_MOVE_FLIGHT_ACK_OBSOLETE",    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*341*/  StoreOpcode( MSG_MOVE_START_SWIM_CHEAT,         "MSG_MOVE_START_SWIM_CHEAT",        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    /*342*/  StoreOpcode( MSG_MOVE_STOP_SWIM_CHEAT,          "MSG_MOVE_STOP_SWIM_CHEAT",         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
