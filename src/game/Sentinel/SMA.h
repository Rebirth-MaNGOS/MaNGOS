...
/* This class implementation was taken from http://rosettacode.org/wiki/Averages/Simple_moving_average#C.2B.2B 
   It produces a moving average of the inputted numbers. */
