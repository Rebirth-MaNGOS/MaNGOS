...
class MANGOS_DLL_SPEC ChatHandler
{
    ...
    protected:
		...
		bool HandleLookupPlayerIpAllCommand(char* args);
        ...
        //----------------------------------------------------------
		bool HandleAddBGCreatureCommand(char* args);
		bool HandleAddSDZCreatureWaypoint(char* args);
		...
		bool HandleBGQueueCommand(char* args);
        ...
        bool HandleBugReportCount(char* args);
        ...
        bool HandleBagClearCommand(char* args);
        bool HandleBagAddCommand(char* args);

        bool HandleMmapPathCommand(char* args);
        bool HandleMmapLocCommand(char* args);
		bool HandleMmapAddPointCommand(char* args);
		bool HandleMmapGeneratePolyFileCommand(char* args);
        ...
        bool LookupPlayerSearchCommand(QueryResult* result, uint32* limit = NULL, bool only_online = false);
