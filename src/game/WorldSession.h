...
enum PartyResult
{
    ERR_PARTY_RESULT_OK                 = 0, // [Yellow Sys Msg] 
    ERR_BAD_PLAYER_NAME_S               = 1, // [Yellow Sys Msg] Cannot Find 'Name'.
    ERR_TARGET_NOT_IN_GROUP_S           = 2, // [Yellow Sys Msg] Name is not in your party.
    ERR_GROUP_FULL                      = 3, // [Yellow Sys Msg] Your party is full.
	ERR_ALREADY_IN_GROUP_S              = 4, // [Yellow Sys Msg] Name already in a group.
    ERR_NOT_IN_GROUP		            = 5, // [Yellow Sys Msg] You aren't in a party.
    ERR_NOT_LEADER		                = 6, // [Yellow Sys Msg] You are not the party leader.
    ERR_PLAYER_WRONG_FACTION            = 7, // [Red Alert Msg] Target is not a member of your faction.
    ERR_IGNORING_YOU_S                  = 8, // [Yellow Sys Msg] Name is ignoring you
    ERR_TARGET_NOT_IN_INSTANCE_S        = 13, // 9+ = nothing? What is ERR_TARGET_NOT_IN_INSTANCE_S for???
    ERR_INVITE_RESTRICTED               = 13, // What is ERR_INVITE_RESTRICTED for???
};
