...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_MAX_ASSIST_CHAIN_COUNT,
    CONFIG_UINT32_EVADE_RESET_TIMER,
    ...
    CONFIG_BOOL_ACTIVE_CONTINENT_MOBS,
...
enum eConfigBoolValues
{
	...
	CONFIG_BOOL_ENABLE_NON_PVP_DECAY,
...
class World
{
    public:
		...
		void SendAntiCheatMessageToGMs(const char* player_name, const char* check_info);
