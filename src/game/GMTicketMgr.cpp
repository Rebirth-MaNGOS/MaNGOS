...
void GMTicketMgr::LoadGMTickets()
{
    ...
    QueryResult *result = CharacterDatabase.Query(
        //      0     1            2              3                                  4				5
        "SELECT guid, ticket_text, response_text, UNIX_TIMESTAMP(ticket_lastchange), ticket_id, is_protected FROM character_ticket ORDER BY ticket_id ASC");
    ...
    do
    {
        ...
        ticket.Init(guid, fields[1].GetCppString(), fields[2].GetCppString(), time_t(fields[3].GetUInt64()), fields[5].GetBool());
