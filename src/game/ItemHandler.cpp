...
void WorldSession::SendListInventory(ObjectGuid vendorguid)
{
    ...
    VendorItemData const* tItems = pCreature->GetVendorTemplateItems(GetPlayer());
...
void WorldSession::HandleWrapItemOpcode(WorldPacket& recv_data)
{
	...
	if (!_player->ValidateInventory()) // If the player's inventory is corrupted we return before wrapping the gift.
		return;
